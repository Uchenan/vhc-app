    ...
    methods: {
        ...
        prepareFormData() {
            if(this.imageRead){
                ...
                this.formData.append("file", this.imageRead)
            } else {
                console.log("empty field for now")
            }
        },
        async submitForm(){
            this.prepareFormData()

            await axios.post(`${import.meta.env.VITE_URI}/image/24M0001SA`, {file: this.imageRead}).then(res => {
